...
const HeroSection = () => {
  ...
  const keyDates = [
    ...
    },
    {
      ...
      date: t("hero.submissionsDueDate"),
      bgColor: "bg-green-50",
    ...
    },
    {
      icon: (
        <img
          src={winnersIcon}
          alt="WINNERS TRAVEL TO MOSIP CONNECT"
          className="w-6 h-6 object-contain"
        />
      ),
      label: t("hero.winnersTravel"),
      date: t("hero.winnersTravelDate"),
                ...
                >
                  <p className="sm:text-lg md:text-xl lg:text-[24px] xl:text-[24px] font-semibold leading-tight break-words max-w-full px-2 sm:px-0 text-[20px]">
                    <span className="text-black">
                      {t("hero.fuellingIntegration")}
                    </span>

                    <span style={{ color: "#01A2FD" }}>
                      {t("hero.integration")}
                    </span>
                    <span className="text-black">, </span>
                    <span style={{ color: "#FA8005" }}>
                      {t("hero.innovation")}
                    </span>
