                    ...
                    <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-4 rounded-lg border border-amber-200">
                        ...
                        <p className="text-gray-700 leading-relaxed mb-3">
                            <Trans
                                ...
                                components={{
                                    sdgLink: <a href="https://sdgs.un.org/goals" target="_blank"
                    ...
                    <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            ...
                            <div
                                ...
                                style={{backgroundColor: "#F58020"}}
                            >
                                <h6 className="font-medium">{t("accordion.academicLeaders")}</h6>
                            </div>
                            <div
                                className="text-center p-4 rounded-lg text-white"
                                style={{backgroundColor: "#098855"}}
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left font-semibold">{t("accordion.date")}</th>
                                </tr>
                                </thead>
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h6 className="font-semibold text-gray-900">{t("accordion.step2Title")}</h6>
                                        <p className="text-sm text-gray-600 mb-3">
                                            <Trans
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h6 className="font-semibold text-gray-900">{t("accordion.step3Title")}</h6>
                                        <p className="text-sm text-gray-600">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="ml-4 space-y-4">
                                        ...
                                        <div>
                                            <h6 className="font-medium text-white mb-2">{t("accordion.injiWalletDemosTitle")}</h6>
                                            <div className="ml-4 space-y-2">
                                                <div>
                                                    <a
                        ...
                        <div
                            ...
                            style={{backgroundColor: "#F58020"}}
                        >
                            <h5 className="text-xl font-bold text-white mb-6">{t("accordion.esignetTitle")}</h5>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="ml-4 space-y-4">
                                        ...
                                        <div>
                                            <h6 className="font-medium text-white mb-2">{t("accordion.demoTitle")}</h6>
                                            <div className="ml-4">
                                                <div>
                                                    <a
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
                            <div className="p-4" style={{backgroundColor: "#1B52A4"}}>
                                <h5 className="font-bold text-white">{t("accordion.resultsTitle")}</h5>
                            </div>
                            <div className="p-6 space-y-6">
                                <div>
                                    <h6 className="font-semibold text-gray-900 mb-2">
    ...
    return (
        <section id="accordion-sections" className="py-16 bg-gray-50">
            ...
            >
                ...
                >
                    <div
                        className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full border border-gray-200 mb-4">
