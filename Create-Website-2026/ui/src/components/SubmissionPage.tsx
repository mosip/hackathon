...
const SubmissionPage: React.FC<SubmissionPageProps> = ({ onNavigateHome }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(t("submission.submissionSuccess"));
        resetCaptcha();
      } else {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-blue-800 flex items-center gap-2">
            ...
            <strong>{t("submission.note")}:</strong>{" "}
            {t("submission.mandatoryFields")}{" "}
            <span className="text-red-600 font-bold">*</span>{" "}
            {t("submission.mandatoryFields2")}
          </p>
        </div>
                  ...
                  {isTeamNameError && (
                    <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                      <AlertCircle
                        ...
                        style={{ marginTop: "1px" }}
                      />
                      <span>{t("submission.teamNameError")}</span>
                    </div>
                  )}
                ...
                {isEmailError && (
                  <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                    <AlertCircle
                      ...
                      style={{ marginTop: "1px" }}
                    />
                    <span>{t("submission.emailError")}</span>
                  </div>
                )}
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-gray-50 border-gray-200 focus:border-[#01A2FD]">
                      <SelectValue
                        placeholder={t("submission.themeChosenPlaceholder")}
                      />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  {isIdeaTitleError && (
                    <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                      <AlertCircle
                        ...
                        style={{ marginTop: "1px" }}
                      />
                      <span>{t("submission.ideaTitleError")}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <Label
                    ...
                    className="flex items-center gap-1"
                  >
                    {t("submission.ideaDescriptionLabel")}
                    <span className="text-red-600">*</span>
                  </Label>
                  <Textarea
                    id="ideaDescription"
                  ...
                  {isIdeaDescriptionError && (
                    <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                      <AlertCircle
                        ...
                        style={{ marginTop: "1px" }}
                      />
                      <span>{t("submission.ideaDescriptionError")}</span>
                    </div>
                  )}
                </div>
              </div>
                ...
                >
                  <Label htmlFor="file-upload" className="cursor-pointer">
                    ...
                    <span className="text-gray-500">
                      {t("submission.fileUploadPlaceholder2")}
                    </span>
                  </Label>
                  <Input
                    id="file-upload"
                  ...
                  {isProblemChallengeError && (
                    <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                      <AlertCircle
                        ...
                        style={{ marginTop: "1px" }}
                      />
                      <span>{t("submission.problemError")}</span>
                    </div>
                  )}
                </div>
                  ...
                  {isTargetAudienceError && (
                    <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                      <AlertCircle
                        ...
                        style={{ marginTop: "1px" }}
                      />
                      <span>{t("submission.targetAudienceError")}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="additionalComments">
                  ...
                  <span className="text-gray-500 text-sm">
                    {t("submission.additionalCommentsOptional")}
                  </span>
                </Label>
                <Textarea
