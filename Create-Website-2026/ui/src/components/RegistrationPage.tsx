...
const RegistrationPage: React.FC<RegistrationPageProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success(
                    t("registration.submissionSuccess")
                );
                resetCaptcha();
            } else {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <p className="text-sm text-blue-800 flex items-center gap-2">
                        ...
                        <strong>{t("registration.note")}</strong> {t("registration.mandatoryFields")}{" "}
                        <span className="text-red-600 font-bold">*</span> {t("registration.mandatoryFields2")}
                    </p>
                </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label htmlFor="fullName" className="flex items-center gap-1">
                                        {t("registration.fullNameLabel")} <span className="text-red-600">*</span>
                                    </Label>
                                    <Input
                                        id="fullName"
                                        name="fullName"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="country" className="flex items-center gap-1">
                                        {t("registration.countryLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Select
                        ...
                        <CardContent className="p-6">
                          ...
                          {t("registration.emailError")}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            {t("registration.organizationNameLabel")}<span
                                        ...
                                        {isOrganizationNameError && (
                                            <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                                                <AlertCircle
                                                    ...
                                                    style={{marginTop: "1px"}}
                                                />
                                                <span>placeholder={t("registration.organizationNameError")}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="linkedinUrl">
                                        ...
                                        <span
                                            className="text-gray-500 text-sm">{t("registration.linkedinUrlOptional")}</span>
                                    </Label>
                                    <Input
                                        id="linkedinUrl"
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <Label htmlFor="teamSize" className="flex items-center gap-1">
                                        {t("registration.teamSizeLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Select
                                    ...
                                    >
                                        <SelectTrigger className="bg-gray-50 border-gray-200 focus:border-[#007aff]">
                                            <SelectValue placeholder={t("registration.teamSizePlaceholder")}/>
                                        </SelectTrigger>
                                        <SelectContent>
                                            {teamSizes.map((size) => (
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="teamName" className="flex items-center gap-1">
                                        {t("registration.teamNameLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Input
                                        id="teamName"
                                        name="teamName"
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label
                                        ...
                                        className="flex items-center gap-1"
                                    >
                                        {t("registration.themeChosenLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Select
                                ...
                                <div className="space-y-2">
                                    <Label
                                        ...
                                        className="flex items-center gap-1"
                                    >
                                        {t("registration.ideaTitleLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Input
                                        id="ideaTitle"
                                        name="ideaTitle"
                        ...
                        {t("registration.ideaTitleError")}
                                ...
                                <div className="space-y-2">
                                    <Label
                                        ...
                                        className="flex items-center gap-1"
                                    >
                                        {t("registration.ideaDescriptionLabel")}<span className="text-red-600">*</span>
                                    </Label>
                                    <Textarea
                                        id="ideaDescription"
                                    ...
                                    {isIdeaDescriptionError && (
                                        <div className="flex items-start gap-1.5 text-xs text-red-600 ">
                                            ...
                                            />
                                            <span>
                        {t("registration.ideaDescriptionError")}
                      </span>
                                        </div>
                                    )}
                                </div>
                                            ...
                                            <Trans
                                                ...
                                                components={{
                                                    termsLink: (
                                                        ...
                                                        >
                                                            <ExternalLink
                                                                className="w-3 h-3 inline ml-1 align-text-top"/>
                                                        </a>
                                                    ),
                                                }}
                                            />
